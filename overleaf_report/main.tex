...
\usepackage{setspace}
\setstretch{1.05}
\title{Inflation Nowcasting Report}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.62\textwidth]{figures/target_series.png}
...
Lasso (mean\_pooled, delta, lag=24) & 0.1663 & 5.9219 & 0.5747 \\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.72\textwidth]{figures/holdout_metric_comparison.png}
\caption{Hold-out metric comparison.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.72\textwidth]{figures/xgb_actual_vs_pred.png}
\caption{XGBoost: actual vs predicted on held-out test.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.72\textwidth]{figures/lstm_actual_vs_pred.png}
...
\begin{enumerate}
  ...
  \item LSTM is useful for sequence comparison but did not beat XGBoost here.
  \item Performance varies by macro regime in rolling windows.
